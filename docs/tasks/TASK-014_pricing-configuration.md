...
- [ ] PricingConfiguration with @ConfigurationProperties(prefix = "pricing")
- [ ] Nested classes: BreadRules, VegetableRules, BeerRules
- [ ] All fields have validation annotations (@NotNull, @DecimalMin, etc.)
- [ ] application.yml with all pricing rules
