...
- [ ] Example order test (€4.86) passes
- [ ] All product type specific tests pass
- [ ] Error handling tests pass (400, 422 responses)
- [ ] Edge cases tested (large orders, boundary values)
- [ ] Full flow integration test validates all endpoints
- [ ] All tests run with @SpringBootTest for real Spring context
- [ ] Test coverage > 90%
