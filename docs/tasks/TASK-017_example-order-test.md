...
- [ ] Example order test passes with €4.86 total
- [ ] Individual product type tests validate correct discount application
- [ ] Bread: 3 units at 3 days = €2.00 final (€1.00 discount)
- [ ] Vegetables: 200g = €1.86 final (€0.14 discount / 7%)
- [ ] Beer: 6 Dutch = €1.00 final (€2.00 pack discount)
- [ ] Test uses @SpringBootTest for full integration
- [ ] All edge cases covered (boundary values, no discount scenarios)
