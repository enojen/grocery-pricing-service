...
import com.grocery.pricing.pricing.strategy.PricingStrategy;
...
- `src/main/java/com/grocery/pricing/service/OrderPricingService.java`
- `src/test/java/com/grocery/pricing/service/OrderPricingServiceTest.java`

## Acceptance Criteria

- [ ] OrderPricingService auto-discovers strategies via Spring DI
- [ ] Correctly groups items by ProductType
- [ ] Delegates to appropriate strategy for each type
- [ ] Correctly calculates subtotal, totalDiscount, and total
- [ ] Throws IllegalStateException for unknown product types
- [ ] All unit tests pass
