...
- [x] BeerPackDiscountRule implements BeerDiscountRule interface
- [x] Only applicable when at least 1 complete pack exists
- [x] Belgian pack discount: €3.00 per pack
- [x] Dutch pack discount: €2.00 per pack
- [x] German pack discount: €4.00 per pack
- [x] Multiple packs calculated correctly
- [x] Final price is always positive (design prevents negative prices)
- [x] Uses configuration for discounts (not hardcoded)
